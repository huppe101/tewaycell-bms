...
api = remote.API('http://your-home-assistant-url:8123', 'your-api-password')
remote.update_entity(api,'sensor.soc', 'state', soc)
...
remote.update_entity(api,'sensor.cell1', 'state', cell1)
remote.update_entity(api,'sensor.cell2', 'state', cell2)
remote.update_entity(api,'sensor.cell3', 'state', cell3)
remote.update_entity(api,'sensor.cell4', 'state', cell4)
remote.update_entity(api,'sensor.cell5', 'state', cell5)
remote.update_entity(api,'sensor.cell6', 'state', cell6)
remote.update_entity(api,'sensor.cell7', 'state', cell7)
remote.update_entity(api,'sensor.cell8', 'state', cell8)
remote.update_entity(api,'sensor.cell9', 'state', cell9)
remote.update_entity(api,'sensor.cell10', 'state', cell10)
remote.update_entity(api,'sensor.cell11', 'state', cell11)
remote.update_entity(api,'sensor.cell12', 'state', cell12)
remote.update_entity(api,'sensor.cell13', 'state', cell13)
remote.update_entity(api,'sensor.cell14', 'state', cell14)
remote.update_entity(api,'sensor.cell14', 'state', cell15)
